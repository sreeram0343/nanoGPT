...
import { SlidersHorizontal, GitBranch } from "lucide-react";
...
export const Header: React.FC<HeaderProps> = ({ onOpenSpecs }) => {
  return (
    <header className="w-full border-b border-neutral-800/60 bg-neutral-950 px-4 sm:px-6 py-3.5 flex items-center justify-between sticky top-0 z-40">
      ...
      {/* Left: Minimalist Title & Tag */}
      <div className="flex items-center gap-2.5">
        <span className="text-sm font-medium text-neutral-300 tracking-tight">
          Tiny Transformer
        </span>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <a
          ...
          className="p-1.5 rounded-lg bg-neutral-900 hover:bg-neutral-850 border border-neutral-800 text-neutral-400 hover:text-neutral-200 transition-colors"
